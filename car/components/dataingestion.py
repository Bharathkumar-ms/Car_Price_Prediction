...
#from car.components.datatransformation import DataTransformationConfig

#from car.components.model_trainer import ModelTrainerConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook/data/car.csv')
